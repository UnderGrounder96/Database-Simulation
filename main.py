...
def mainly():
    try:
        try:
            parser = argparse.ArgumentParser(description="This program is a front-end for MySQL server \
and allows basic CRUD operations. Please run \'python main.py\' in order to use it.")
            parser.parse_args()
